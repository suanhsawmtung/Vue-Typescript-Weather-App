<template>
    <div class="flex bg-weather-secondary py-6 px-3 rounded-md shadow-md cursor-pointer">
...
import type { RetrievedCityWeatherView } from '@/types/index'

defineProps({
    city: {
        type: Object as PropType<RetrievedCityWeatherView>,
        default: () => {}
    }
})
</script>